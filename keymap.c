...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // 
     [0] = LAYOUT(
        KC_ESC,    CAPSWORD,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK, KC_MEDIA_PLAY_PAUSE,          KC_MUTE,
        ...
        KC_LCTL,   SNAKECASE,    KC_LALT,                            KC_SPC,                             KC_RALT, MO(1),               KC_RCTL,             KC_LEFT,             KC_DOWN, KC_RGHT
    ),
